...
echo "   AI_FALLBACK_MODELS       = inclusionai/ring-2.6-1t:free,poolside/laguna-xs.2:free,poolside/laguna-m.1:free,nvidia/nemotron-3-super-120b-a12b:free,minimax/minimax-m2.5:free,openrouter/free,liquid/lfm-2.5-1.2b-thinking:free,liquid/lfm-2.5-1.2b-instruct:free"
